...
// 32 20 8 8 12
// # acde-ab-bcde
// # t3 [a,c,d,e] += sum(b) * t2 [a,b] * v2 [b,c,d,e];
//
int main(int argc, char **argv)
{
    ...
    size_C = size_idx_a * size_idx_c * size_idx_d * size_idx_e;
    ...
    printf("==========================================================================================================\n");
    printf(">>> acde-ab-bcde\n");
    printf(">>> t3 [a,c,d,e] += sum(b) * t2 [a,b] * v2 [b,c,d,e];\n");
    printf(">>> Problem Size (a,c,d,e) and (b): (%2d,%2d,%2d,%2d) and (%2d)\n", size_idx_a, size_idx_c, size_idx_d, size_idx_e, size_idx_b);
    printf("==========================================================================================================\n");
