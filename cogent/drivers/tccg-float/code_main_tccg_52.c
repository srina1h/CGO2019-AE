...
int main(int argc, char **argv)
{
    ...
    printf("==========================================================================================================\n");
    printf(">>> ac-ab-cb\n");
    printf(">>> # t3 [a,c] += sum(b) * t2 [a,b] * v2 [c,b];\n");
    printf(">>> Problem Size (a,c) and (b): (%2d,%2d) and (%2d)\n", size_idx_a, size_idx_c, size_idx_b);
    printf("==========================================================================================================\n");
