...
// 12 8 20 8 20
// # abde-abc-cde
// # t3 [a,b,d,e] += sum(c) * t2 [a,b,c] * v2 [c,d,e];
//
int main(int argc, char **argv)
{
    ...
    size_C = size_idx_a * size_idx_b * size_idx_d * size_idx_e;
    size_A = size_idx_a * size_idx_b * size_idx_c;
    size_B = size_idx_c * size_idx_d * size_idx_e;
    ...
    printf("==========================================================================================================\n");
    printf(">>> abde-abc-cde\n");
    printf(">>> t3 [a,b,d,e] += sum(c) * t2 [a,b,c] * v2 [c,d,e];\n");
    printf(">>> Problem Size (a,b,d,e) and (c): (%2d,%2d,%2d,%2d) and (%2d)\n", size_idx_a, size_idx_b, size_idx_d, size_idx_e, size_idx_c);
    printf("==========================================================================================================\n");
