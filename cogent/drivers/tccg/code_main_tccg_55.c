...
// 4096 12 12 8 300
// # ae-abcd-bcde
// # t3 [a,e] += sum(b,c,d) * t2 [a,b,c,d] * v2 [b,c,d,e];
//
int main(int argc, char **argv)
{
    ...
    // # ae-abcd-bcde
    // # t3 [a,e] += sum(b,c,d) * t2 [a,b,c,d] * v2 [b,c,d,e];
    size_internal = size_idx_b * size_idx_c * size_idx_d;
    size_C = size_idx_a * size_idx_e;
    size_A = size_idx_a * size_idx_b * size_idx_c * size_idx_d;
    size_B = size_idx_b * size_idx_c * size_idx_d * size_idx_e;
    ...
    printf("==========================================================================================================\n");
    printf(">>> ae-abcd-bcde\n");
    printf(">>> t3 [a,e] += sum(b,c,d) * t2 [a,b,c,d] * v2 [b,c,d,e]\n");
    printf(">>> Problem Size (a,e) and (b,c,d): (%2d,%2d) and (%2d,%2d,%2d)\n", size_idx_a, size_idx_e, size_idx_b, size_idx_c, size_idx_d);
    printf("==========================================================================================================\n");
